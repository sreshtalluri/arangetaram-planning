...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[360px] h-[500px] bg-white rounded-xl shadow-2xl flex flex-col z-50 overflow-hidden">
      ...
      {/* Messages area */}
      <div className="flex-1 overflow-y-auto p-4 space-y-3 chat-messages-scroll">
      ...
      <div className="p-3 border-t border-[#E5E5E5] shrink-0">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 px-4 py-2.5 bg-[#F9F8F4] border border-[#E5E5E5] rounded-2xl text-sm focus:outline-none focus:border-[#0F4C5C] disabled:opacity-50 resize-none overflow-y-auto chat-input-area"
          />
          <Button
            onClick={handleSend}
